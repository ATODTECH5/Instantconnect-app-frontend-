...
/**
 * Placeholder copy carried over from the design frames. Replacing these strings
 * with the real terms is the only change needed; nothing renders off the text.
 */
export const TERMS: TermsDocument = {
	...
	sections: [
		...
		{
			id: "meetups",
			heading: "Meetups and Personal Safety",
			paragraphs: [
